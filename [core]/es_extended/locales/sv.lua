Locales["sv"] = {
  ...
  ["received_weapon_hasalready"] = "%s har försökt gett dig en %s, men du har redan det vapnet",
  ["received_weapon_noweapon"] = "%s har försökt ge dig ammo till en %s, men du har inte detta vapen",
  ["gave_account_money"] = "Ger %skr (%s) till %s",
  ["received_account_money"] = "Mottog %skr (%s) från %s",
  ["amount_invalid"] = "Ogiltig summa",
  ["players_nearby"] = "Ingen i närheten",
  ["ex_inv_lim"] = "Kan inte genomföras, du överskrider maxvikten på %s",
  ["imp_invalid_quantity"] = "Kan inte genomföras, mängden är ogiltigt",
  ["imp_invalid_amount"] = "Kan inte genomföras, antalet är ogiltigt",
  ...
  ["threw_cannot_pickup"] = "Inventoryt är fullt, Du kan inte plocka upp!",
  ...
  ["received_help"] = "Du har blivit betald: %skr",
  ["company_nomoney"] = "Företaget du är anställd hos har inte råd med din lön",
  ...
  ["in_vehicle"] = "Kan inte utföra, spelare är i fordon",
  ["not_in_vehicle"] = "Kan inte utföra, spelare är inte i fordon",

  -- Commands
  ['command_bring'] = 'Ta spelare till dig',
  ['command_car'] = 'Ta fram ett fordon',
  ['command_car_car'] = 'namn',
  ['command_cardel'] = 'Raderar fordon inom specifik radie',
  ['command_cardel_radius'] = 'Raderar ALLA fordon inom en specifik radie',
  ['command_repair'] = 'Reparera ditt fordon',
  ['command_repair_success'] = 'Fordonet lagat',
  ['command_repair_success_target'] = 'En admin reparerade ditt fordon',
  ['command_clear'] = 'Rensa chatten',
  ['command_clearall'] = 'Rensa chatten för alla spelare',
  ['command_clearinventory'] = 'Raderar alla föremål från spelarens inventory',
  ['command_clearloadout'] = 'Raderar alla vapen från spelarens inventory',
  ['command_freeze'] = 'Frys en spelare',
  ['command_unfreeze'] = 'Ta bort frysning från spelare',
  ...
  ['command_removeaccountmoney'] = 'Ta bort pengar från specifikt konto',
  ...
  ['command_giveitem'] = 'Ge en spelare ett föremål',
  ['command_giveitem_item'] = 'Namn',
  ['command_giveitem_count'] = 'Antal',
  ['command_giveweapon'] = 'Ge en spelare ett vapen',
  ...
  ['command_giveweaponcomponent'] = 'Ge vapen komponent till en spelare',
  ['command_giveweaponcomponent_component'] = 'Komponentnamn',
  ...
  ['command_giveweaponcomponent_missingweapon'] = 'Spelaren har inte det vapnet',
  ...
  ['command_setjob'] = 'Sätt en spelares jobb',
  ['command_setjob_job'] = 'Namn',
  ['command_setjob_grade'] = 'Grad',
  ['command_setjob_invalid'] = 'Jobbet, graden eller båda är felaktiga',
  ...
  ['command_giveammo_weapon'] = 'Namn',
  ['command_giveammo_ammo'] = 'Antal skott',
  ['tpm_nowaypoint'] = 'Ingen markör sutten.',
  ['tpm_success'] = 'Teleporterad',
